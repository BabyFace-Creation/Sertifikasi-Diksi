                  ...
                  <div class="x_content">
                    ...
                    <form action="proses/proses_inputsuratmasuk.php"  name="formsuratmasuk" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <?php include '../koneksi/koneksi.php';
                          $sql2 		= "SELECT * FROM tb_suratmasuk ORDER BY id_suratmasuk DESC LIMIT 1" ;  
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Judul Surat <span class="required">*</span>
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="judul" name="judul" required="required" placeholder="Masukkan Judul Surat" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>               
